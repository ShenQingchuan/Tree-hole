  ...
  return (
    <View className={clsx(s.app_anniversary, 'flex_col', 'center_all', 'h_full')}>
      <View className={clsx(s.app_anniversary__highlight, 'flex_col')}>
        ...
        <View className={clsx(s.app_anniversary__highlight_days,'fs_81', 'fw_bold', 'tc_white', 'flex_row', 'center_all')}>
          {dayjs().diff(dayjs('2019-06-21'), 'day')}
          <Text className={clsx(s.app_anniversary__highlight_days_label,'fs_32', 'fw_400', 'tc_white', 'm_l_8', 'p_8')}>
            DAYS
          </Text>
        </View>
      </View>
